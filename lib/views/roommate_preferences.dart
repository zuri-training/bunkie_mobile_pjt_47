...
class RoommatePreferencesView extends StatefulWidget {
  _RoommatePreferencesViewState createState() => _RoommatePreferencesViewState();
}
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                CustomSpacer(flex: 2),
                Text(
                  'Let us know what you expect from your new roommate',
                ...
                CustomSpacer(flex: 2),
                CustomDropdown(hintText: 'Religion', items: ['Christian', 'Muslim']),
                CustomSpacer(flex: 2),
                CustomDropdown(hintText: 'Tribe', items: []),
                CustomSpacer(flex: 2),
                CustomDropdown(hintText: 'Level', items: ['100', '200', '300', '400', '500', '600']),
                CustomSpacer(flex: 2),
